...
var auth = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, decoded, userRepository, user, err_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!token)
                    return [2 /*return*/, res.status(401).send('Access denied. No token provided.')];
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                decoded = jsonwebtoken_1.default.verify(token, 'your_jwt_secret');
                userRepository = (0, typeorm_1.getRepository)(User_1.User);
                return [4 /*yield*/, userRepository.findOne({ where: { id: decoded.userId } })];
            case 2:
                user = _b.sent();
                if (!user)
